...
$("#sim_name").on('change', function() {
    ...
    document.getElementById('submit-setup-button-div').innerHTML = '<div class="col s12 center-align"><button id="submit-setup-button" type="submit" class="btn-large light-blue text-shadow">Submit<i class="fas fa-plus-square right"></i></button></div>'
